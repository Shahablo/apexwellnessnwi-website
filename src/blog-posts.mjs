...
import { glp1CoverageArticle } from './glp1-coverage-article.mjs';
...
export const blogPosts = Object.freeze([
  ...
  personalGoalsArticle,
  {
    ...
    "heroImage": "shoreline",
    "relatedService": {
      "label": "Explore our approach to care",
      "href": "/how-it-works/"
    },
    "sections": [
      {
        "heading": "Our Merrillville location",
        "paragraphs": [
          "8550 Broadway, Suite B, Merrillville, IN 46410.",
          "Apex serves Northwest Indiana, including Merrillville, Crown Point, Schererville, Munster, Dyer, St. John, Highland, and Hobart. Coming soon to a location close to the routines, workdays, and family commitments that shape everyday life here."
        ]
      },
      {
        ...
        "paragraphsAfterBullets": [
          ...
          "You do not need an athletic background or an impressive hobby. Your reasons for seeking care belong in the conversation, whether they involve a favorite activity or simply wanting to feel more like yourself."
        ]
      },
      {
        "heading": "Meet the people behind Apex",
        "paragraphs": [
          "Atif Muhammad, MD, brings his perspective as a physician and an active weightlifter. Outside medicine, he enjoys fitness and travel.",
          "Shahab Siddique grew up wrestling and enjoys lifting, BJJ, Muay Thai, and boxing. His interest in staying involved in those activities as he gets older helped inspire Apex.",
          "Our About page shares more of that story. Those personal interests explain part of our motivation, not a checklist for the people we welcome."
        ]
      },
      {
        "heading": "Follow the launch",
        "paragraphs": [
          "Join the Launch List with your name and email to receive opening updates. You can also find launch updates at apexwellnessnwi.com.",
          "Keep medical history, symptoms, and test results out of the signup form. It is designed for contact details, so you can hear from us as the practice takes shape."
        ]
      },
      {
        "heading": "A clear place to start",
        "paragraphs": [
          "Explore the care pages, meet the team, and read about our approach. The FAQ and pricing page provide practical information in one place.",
          "Coming soon to Merrillville. We look forward to introducing you to Apex."
        ]
      }
    ],
    "sources": [
      {
        "label": "Apex Wellness: Care and launch updates",
        "href": "https://apexwellnessnwi.com/"
      },
      {
        "label": "Apex Wellness: Meet the team",
        "href": "https://apexwellnessnwi.com/about/"
      },
      {
        "label": "Apex Wellness: Launch List",
  ...
  },
  {
    ...
    sections: [
      {
        ...
        bullets: [
          "Weight history, previous approaches, and what happened afterward",
          "Current medical conditions and family history",
          "Prescription medicines, over-the-counter products, and supplements",
          "Blood pressure and other relevant measurements",
          "Sleep, stress, work schedule, food access, activity, and pain or mobility limits",
          "Eating patterns, hunger, fullness, and possible disordered-eating symptoms",
          "Pregnancy plans and reproductive considerations when relevant",
          "Personal goals, preferences, budget, and treatment concerns",
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          "Weight and waist trends rather than one isolated reading",
          "Blood pressure, glucose, lipids, or other relevant markers",
          "Hunger, fullness, eating patterns, and adherence",
          "Strength, function, sleep, energy, and quality of life",
          "Medication side effects, interactions, dosing, and access",
          "Whether the goals still make sense",
          "Maintenance planning or reasons to change, stop, or refer treatment",
        ],
      },
      {
        ...
        bullets: [
          ...
          "A guaranteed number of pounds by a guaranteed date",
          "The same laboratory panel, diet, or dose schedule for everyone",
          "That one product will fix every metabolic or hormonal concern",
          "That FDA-approved and compounded products are interchangeable",
          "That maintenance will somehow take care of itself",
        ],
      },
      {
        ...
        bullets: [
          "What health outcome matters most to me?",
          "Which factors may be affecting my weight or metabolic health?",
          "What options are reasonable, and what are the tradeoffs?",
          "If medication is considered, why this medication and how will it be monitored?",
          "How will we protect nutrition, strength, and muscle during weight loss?",
          "What would make us continue, adjust, stop, or refer the plan?",
      ...
      {
        heading: "Request future consultation information",
        paragraphs: [
          "Apex Wellness is preparing to open. You may request future contact about opening-month consultation availability. Submitting a request is free, does not book an appointment, does not establish a clinician-patient relationship, and does not guarantee treatment or a prescription.",
        ],
      },
    ],
    sources: [
      {
        label: "CDC: Consequences of Obesity",
        href: "https://www.cdc.gov/obesity/php/about/consequences.html",
      },
      {
        label: "NIDDK: Treatment for Overweight & Obesity",
      ...
      {
        label: "2026 ADA/Obesity Association: Screening and Diagnosis of Obesity",
        href: "https://doi.org/10.2337/doci26-0003",
      },
      {
        label: "2026 ADA/Obesity Association: Pharmacologic Treatment of Obesity",
        href: "https://doi.org/10.2337/doci25-0008",
      },
      {
        label: "USPSTF: Behavioral Interventions for Weight Loss in Adults",
        href: "https://www.uspreventiveservicestaskforce.org/uspstf/document/RecommendationStatementFinal/obesity-in-adults-interventions",
      },
      {
    ...
    disclaimer:
      "This article provides general educational information and is not medical advice, diagnosis, or treatment. Individual risks and treatment decisions require evaluation by a qualified healthcare professional. Apex Wellness does not provide urgent or emergency care. Call 911 or go to the nearest emergency department for a medical emergency.",
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Not everyone needs or tolerates the highest labeled maintenance dose. Dose decisions should consider response, side effects, other medical conditions, and the specific product instructions.",
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          "Try smaller meals and eat slowly enough to notice fullness.",
          "Stop eating at comfortable fullness rather than testing whether the medicine can win an argument with a buffet.",
          "Notice whether very large, rich, or high-fat meals reliably worsen symptoms.",
          "Drink fluids regularly unless a heart, kidney, or other condition requires a different fluid plan.",
          "Discuss a gradual fiber and constipation strategy rather than adding several remedies at once.",
          "Keep a short record of symptoms, bowel pattern, food and fluid triggers, and their timing relative to each dose.",
          "Ask before using an anti-nausea medicine, laxative, supplement, or dose change.",
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          "Signs of dehydration, including very dark or infrequent urine, marked dizziness, or faintness",
          "Severe or persistent abdominal pain, especially if it reaches the back",
          "Upper abdominal pain with fever, jaundice, or pale/clay-colored stool",
          "New or worsening vision changes, particularly with diabetes",
          "Symptoms of low blood sugar, especially if insulin or a sulfonylurea or other insulin secretagogue is also used",
          "Severe or worsening stomach or bowel symptoms",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "Diabetes medicines, kidney issues, gallbladder or pancreas history, significant digestive disease, diabetic eye disease, and upcoming procedures requiring general anesthesia or deep sedation can also affect the plan. Tell both the prescribing team and the procedure team which medication you use and when you last took it; do not hold or change it for a procedure without individualized instructions.",
        ],
      },
      {
      ...
      },
      {
        heading: "Request future consultation information",
        paragraphs: [
          "Apex Wellness is preparing to open. You may request future contact about opening-month consultation availability. The request is free and is not an appointment, acceptance as a patient, or guarantee of medication or treatment.",
        ],
      },
    ],
    sources: [
      {
        label: "FDA prescribing information: Wegovy (semaglutide), revised February 2026",
        href: "https://www.accessdata.fda.gov/drugsatfda_docs/label/2026/215256s033lbl.pdf",
      },
      {
        label: "DailyMed/FDA label: Zepbound (tirzepatide), updated August 28, 2026",
      ...
      {
        label: "STEP 1 trial: Once-Weekly Semaglutide in Adults With Overweight or Obesity",
        href: "https://www.nejm.org/doi/full/10.1056/NEJMoa2032183",
      },
      {
        label: "SURMOUNT-1 trial: Tirzepatide Once Weekly for the Treatment of Obesity",
        href: "https://www.nejm.org/doi/full/10.1056/NEJMoa2206038",
      },
      {
        label: "MedlinePlus: Semaglutide Injection",
      ...
      {
        label: "STEP 1 extension: Weight Regain After Withdrawal of Semaglutide",
        href: "https://pmc.ncbi.nlm.nih.gov/articles/PMC9542252/",
      },
      {
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          "Weigh at a similar time, often in the morning after using the bathroom and before eating or drinking.",
          "Wear similar clothing, or none.",
          "Look at a weekly average or several-week trend rather than the highest or lowest day.",
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          "Skip meals while ignoring protein, fiber, or hydration",
          "Double workouts despite pain or poor recovery",
          "Increase, combine, or restart medication on your own",
          "Treat side effects as the price of admission",
          "Buy an unverified product because an ad promised to “break the plateau”",
        ],
      },
      {
      ...
      },
      {
        heading: "Request future consultation information",
        paragraphs: [
          "Apex Wellness is preparing to open. You may request future contact about opening-month consultation availability. A request is free and does not book an appointment, establish a clinician-patient relationship, or guarantee treatment or a particular result.",
        ],
      },
    ],
    sources: [
      {
        label: "NIDDK: Factors Affecting Weight & Health",
        href: "https://www.niddk.nih.gov/health-information/weight-management/adult-overweight-obesity/factors-affecting-weight-health",
      },
      {
        label: "NIDDK: Treatment for Overweight & Obesity",
        href: "https://www.niddk.nih.gov/health-information/weight-management/adult-overweight-obesity/treatment",
      ...
      {
        label: "PubMed: Timeline of Changes in Energy Expenditure With Progressive Weight Loss",
        href: "https://pubmed.ncbi.nlm.nih.gov/29733003/",
      },
      {
        label: "PMC: Daily Self-Weighing to Control Body Weight in Adults",
        href: "https://pmc.ncbi.nlm.nih.gov/articles/PMC4846305/",
      },
      {
      ...
      {
        label: "PMC: Resistance Training and Body Composition in People With Overweight or Obesity",
        href: "https://pmc.ncbi.nlm.nih.gov/articles/PMC9285060/",
      },
    ],
    disclaimer:
      "This article provides general educational information and is not medical advice, diagnosis, or treatment. Sudden weight change, swelling, shortness of breath, persistent vomiting, severe pain, or other concerning symptoms may require prompt medical evaluation. For a medical emergency, call 911 or go to the nearest emergency department.",
  },
]);
